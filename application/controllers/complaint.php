...
//**************************************************************
//==============================================================	
	function complaint_remark()
	{
	$complaint_id_decode=$this->page_setting->first_auto_decoded_id;
	    if ($_POST) {
	     $data_p ['customer_complaint_is_done'] =  "1";
	     $data_p ['customer_complaint_remarks'] =  $_POST['customer_complaint_remarks'];
       $id = $this->complaint_m->updateComplaintById($complaint_id_decode,$data_p);
	    }
